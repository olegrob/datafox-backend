...
function ClientsTable({ clients, onRowClick }) {
  return (
...
function ClientsContent() {
  ...
  }, [pagination.page, debouncedSearch, session]);
  ...
  if (!session) {
    return (
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold mb-4">Please sign in to view clients</h1>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {isLoading ? (
        ...
        <>
          <ClientsTable clients={clients} onRowClick={handleRowClick} />
